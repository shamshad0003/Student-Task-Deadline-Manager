  ...
  return (
    <div className="flex flex-col items-center justify-center py-32 space-y-8 animate-fade-in">
      <div className="relative group">
        ...
        <div className="relative overflow-hidden w-20 h-20 bg-white rounded-[2rem] shadow-xl border border-gray-100 flex items-center justify-center">
      ...
      <div className="text-center">
        <p className="text-xl font-black text-gray-900 tracking-tighter mb-1">{message}</p>
        <p className="text-sm font-black text-gray-400 uppercase tracking-[0.2em] animate-pulse">Please wait a moment</p>
      </div>
    </div>
  );
};
